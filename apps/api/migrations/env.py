...
def database_url() -> str:
    """Read one URL source for both runtime and migration commands."""
...
def apply_migrations(connection: Connection) -> None:
    """Configure and run migrations through an existing sync facade."""
    context.configure(
...
async def run_async_migrations() -> None:
    """Create an async migration engine and bridge Alembic's sync API."""
